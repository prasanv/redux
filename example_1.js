/* 
  ...
  - we are using new redux method called bindActionCreators that allows you to bind the action creators to the dispatch function from the store
*/
...
const unsubscribe = store.subscribe(() => {
  console.log(
    "store is subscribed and log is prints updated state after every dispatch = ",
    store.getState()
  );
});

const actions = bindActionCreators(
  { order_cake, restock_cake },
  store.dispatch
);
